    ...
    <section className="container-fluid  text-light py-5 px-4">
      <div className="row align-items-center">
        <div className="col-md-6">
          ...
          <p className="mt-3">
            التسويق ليس مجرد وسيلة للترويج، بل هو فن بناء العلاقات وصناعة التأثير. نحن نؤمن أن النجاح يبدأ بفهم العميل، وإيصال
            الهوية الحقيقية له، فلكي تتمكن من تقديم الاستراتيجيات وأفكارك بطريقة تساهم في التميز، عليك أن تضع رؤيتك في إطار جذاب.
            ابدأ اليوم واستثمر في مستقبل عملك، لأن التسويق هو الجسر الذي يصل أفكارك لعملائك.
          </p>
