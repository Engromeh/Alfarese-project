      ...
      <div className="container">
        <div className="row">
          <div className="col-md-3 text-end">
            ...
            <p className="mt-3">    Marketing is the key to success. Understand your customers, show your value, and build lasting loyalty.</p>
          ...
          <div className="col-md-2 text-end">
          <h5>Support</h5>            <ul className="list-unstyled">
            <li>Account</li>
